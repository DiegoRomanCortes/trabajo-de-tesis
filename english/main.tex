...
\begin{resumen}\ignorespacesafterend
	...
	The experimental and numerical results presented in this thesis reveal new ways to control light propagation by utilizing the orbital degrees of freedom of guided modes, paving the way for the design of advanced photonic lattices with topological and directional functionality.
\end{resumen}
