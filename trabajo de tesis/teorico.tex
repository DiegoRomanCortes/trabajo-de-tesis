...
\begin{align}
	\textbf{E}_\perp &= \hat{\textbf{y}}\frac{i\omega\mu_0 H_{a1}}{k_0^2n^2 - k_z^2}\left\{ \begin{matrix}
-\alpha \cos(\alpha x), |x|\le a
\\
\beta\frac{|x|}{x}\sin(\alpha a) e^{-\beta(|x|-a)}, |x| > a
\end{matrix}\right.
\\
\textbf{H}_\perp &= \hat{\textbf{x}}\frac{ik_z H_{a1}}{k_0^2n^2 - k_z^2}\left\{ \begin{matrix}
\alpha \cos(\alpha x), |x|\le a
\\
-\beta\frac{|x|}{x}\sin(\alpha a) e^{-\beta(|x|-a)}, |x| > a
\end{matrix}\right.
