...
\end{equation} 
Contrario al caso de la guía de ondas tipo baldosa, en fibras ópticas se hace necesario estar bajo un umbral de corte máximo $(\lambda_c)_{0,1}$ no nulo para que los modos TE o TM existan.
...
\subsection{Dímero TE en guías de ondas tipo losa}
