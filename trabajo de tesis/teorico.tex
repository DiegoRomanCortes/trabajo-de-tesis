...
Tomando producto cruz en la dirección $\hat{\textbf{z}}$ a las ecuaciones (\ref{eqn:Efield}) y (\ref{eqn:Hfield}), se puede expresar $E_z$ y $H_z$ en función de $\textbf{E}_\perp$ y $\textbf{H}_\perp$: 
\begin{align*}
	 k_z\textbf{E}_\perp +\omega \mu_0 \hat{\textbf{z}} \times \textbf{H}_\perp &= i\nabla_\perp E_z
	 	 \\
	 k_z  \hat{\textbf{z}} \times \textbf{E}_\perp - \omega \mu_0 \textbf{H}_\perp &=  i\hat{\textbf{z}} \times(\nabla_\perp E_z)
	 	 \\
	 k_z \textbf{H}_\perp - \omega \epsilon_0 n^2  \hat{\textbf{z}} \times \textbf{E}_\perp  &= i \nabla_\perp H_z
	 	  	 \\
	 k_z \hat{\textbf{z}} \times\textbf{H}_\perp + \omega\epsilon_0 n^2 \textbf{E}_\perp  &=i\hat{\textbf{z}} \times \nabla_\perp H_z
	 \\
	 \omega \epsilon_0 n^2(i\nabla_\perp E_z - \omega \mu_0 \hat{\textbf{z}} \times \textbf{H}_\perp ) &= k_z(i\hat{\textbf{z}} \times \nabla_\perp H_z - k_z \hat{\textbf{z}} \times\textbf{H}_\perp)
	 \\
