...
\begin{align*}
	\frac{\alpha a J_0(\alpha a)}{J_1(\alpha a)}  = -\frac{\beta a K_{0}(\beta a)} {K_1(\beta a)} \approx (\beta a)^2(\ln(\beta a/2)+\gamma) \to 0,
\end{align*}
...
\begin{align*}
	...
	\ln(x/2)+\gamma-\frac{1}{x^2} \quad\text{si }\ell = 1
	\\
	\frac{
