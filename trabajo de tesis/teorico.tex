...
\end{align}
Tomando raíz cuadrado al cociente de las ecuaciones (\ref{eqn:fiber_polarization_E}) y (\ref{eqn:fiber_polarization_H}) se tiene:
...
\begin{figure}[H]
	...
	\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberTE1.pdf}
	\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberTM1.pdf}
		\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberHE21.pdf}
		\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberEH11.pdf}
		\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberHE12.pdf}
		\includegraphics[width=0.288\linewidth, trim={1.5cm 0 4.0cm 0},clip]{media/fiberHE31.pdf}
\end{figure}
