...
\section{Desde las ecuaciones de Maxwell a propagación en guías de onda dieléctricas \label{cap:maxwell}}
...
\begin{align}
	\nabla\times\left(\frac{\nabla\times\textbf{E}}{i\omega\mu_0}\right) &=  -\frac{n^2}{c^2}\frac{\partial^2 \textbf{E}}{\partial t^2} = i\omega \varepsilon_0 n^2 \textbf{E} \implies \nabla\times\nabla\times\textbf{E} = k_0^2n^2\textbf{E}, \label{eqn:rotordoble}
\end{align}
...
\end{figure} 
\begin{figure}[h]
\centering	\includegraphics[width=0.6\linewidth]{media/ssh-open}
