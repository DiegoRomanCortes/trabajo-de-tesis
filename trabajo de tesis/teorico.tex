...
\begin{align}
	\implies 
	  \int_{-\infty}^{+\infty}\int_{-\infty}^{+\infty} \sum_{\nu, m} \left[a_{\nu, m}  k_0^2\sum_{m'\neq m} n^2_{m'}  +2i\beta_{\nu,m}\frac{d a_{\nu, m}}{d z} \right]e^{i\beta_{\nu, m} z}\textbf{E}_{\nu, m} \cdot \textbf{E}_{\mu, m''}^* dxdy &= 0
	  \nonumber
	  \\
	  \sum_{\nu, m} \left[a_{\nu, m}  \sum_{m'\neq m}\left( \underbrace{\int_{-\infty}^{+\infty}\int_{-\infty}^{+\infty} k_0^2n^2_{m'} \textbf{E}_{\nu, m} \cdot \textbf{E}_{\mu, m''}^* dxdy}_{C_{m, m', m'', \nu, \mu}}\right) +2i\beta_{\nu,m}\frac{d a_{\nu, m}}{d z} \int_{-\infty}^{+\infty}\int_{-\infty}^{+\infty} \textbf{E}_{\nu, m} \cdot \textbf{E}_{\mu, m''}^* dxdy\right]e^{i\beta_{\nu, m} z} &= 0
	\label{eqn:CMT1}
\end{align}
