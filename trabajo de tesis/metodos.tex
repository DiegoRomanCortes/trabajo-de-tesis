...
\end{figure}
\subsection{Generación de imágenes complejas}
Una forma de verificar el control que se tiene en cuanto a la amplitud y la fase es mediante la generación de vórtices ópticos en el espacio libre, pues tienen bien definido su Momentum Angular Orbital (OAM). Se instaló un interferómetro Mach-Zehnder dentro del Cirucito Óptico. Para ello se deben agregar dos Beams Splitter extra: Uno entre el lente L1 y el modulador y otro entre el espejo M y la cámara. 
\begin{figure}[H]
	\centering
