...
Para usar condiciones iniciales distintas a una gaussiana se hace necesario incorporar métodos de modulación espacial de luz. En esta tesis se implementó una técnica conocida como grabado de fase mediante holograma \citep{terhalle}.
...
\end{itemize}
Para la generación de modos dipolares, es fundamental ajustar la diferencia de fase entre los haces recombinados a un valor cercano a $\pi$. Esto se evidencia experimentalmente mediante la aparición de un mínimo de intensidad en el centro del patrón de interferencia, correspondiente a una interferencia destructiva en esa región.
