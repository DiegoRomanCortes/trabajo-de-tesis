...
Se puede decir que la simulación numérica de las ecuaciones (\ref{eqn:CMT_mat}) es lo más compacta posible en tanto la matriz de acoplamientos $\hat{C}$ codifica todas las propiedades de la red que se deseen estudiar. En este sentido, la diagonalización de la matriz $\hat{C}$ es una herramienta numérica útil en el estudio del comportamiento de la red ante variaciones de parámetros tales como la dimerización (razón entre dos constantes de acoplamiento) o el desintonizado (diferencia entre constantes de propagación de dos modos distintos). 